...
export var validateLuhn = luhn.validate;
/**
...
export var sanitizeNumber = function sanitizeNumber(number) {
...
export var getCardType = function getCardType(cardNumber) {
  var potentialCardTypes = creditCardType(sanitizeNumber(cardNumber));
...
export var setInitialValidCardTypes = function setInitialValidCardTypes() {
