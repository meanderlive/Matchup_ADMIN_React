...
import { RemoveImageintoGallerys, getbyidPets } from '../../../../redux/Slice/PetsManagement';
...
const [removeImage,setRemoveImage]=useState<boolean>(false)
	...
	useEffect(() => {
		dispatch(getbyidPets(ids) as any)
	}, [ids, dispatch])
 ...
 const removeImageFun = (id:any, item:any)=>{
	...
	const GALLERY = (
        ...
        />}
			...
			)) : <p className='text-danger'>The Pet has not uploaded any images.</p>}
		</div>
	);
