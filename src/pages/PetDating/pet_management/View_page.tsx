...
const Customer = () => {
	...
	const PetDAta = useSelector((state: any) => state?.Pet?.Pet?.data)
	const { id } = useParams();
	...
	const dataaaa = PetDAta ? PetDAta[0] : null;
			...
			<Page>
				<div className='pt-3 pb-5 d-flex align-items-center'>
					...
					<div className='col-10'>
						<span className='display-4 fw-bold me-3 text-capitalize ' >{dataaaa?.petName || 'John'}</span>
