...
const LegalEditor: React.FC<IEditModalProps> = ({ isOpen, setIsOpen, id, onSave }) => {
    const Legal: any = localStorage.getItem('Legal');

    const [editorHtml, setEditorHtml] = useState<string>(Legal);
            ...
            <ModalBody>
                <div>
                    ...
                    <div className='mt-3' style={{ maxHeight: '33vh', overflowY: 'auto', border: '1px solid #ced4da', borderRadius: '4px', padding: '8px' }}>
                        <h3>Preview:</h3>
                        <div  style={{ height: '33vh', overflowY: 'auto' }} dangerouslySetInnerHTML={{ __html: editorHtml }} />
                    </div>
                    <Button
