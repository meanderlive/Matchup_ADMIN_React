...
const PrivacyPolicysEditor: React.FC<IEditModalProps> = ({ isOpen,ApiDAta, setIsOpen, id, onSave }) => {
    const PrivacyPolicys: any = localStorage.getItem('PrivacyPolicys');

    const [editorHtml, setEditorHtml] = useState<string>(PrivacyPolicys);
...
export default PrivacyPolicysEditor;
