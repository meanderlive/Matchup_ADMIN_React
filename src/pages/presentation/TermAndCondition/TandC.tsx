...
const TermsAndConditionsEditor: React.FC<IEditModalProps> = ({ isOpen, ApiDAta,setIsOpen, id, onSave }) => {
    const TermCondition: any = localStorage.getItem('TermCondition');

    const [editorHtml, setEditorHtml] = useState<string>(TermCondition);
