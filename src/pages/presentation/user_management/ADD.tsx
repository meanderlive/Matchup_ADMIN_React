				...
				<ModalBody className='px-4 user-modal-body'>
					...
					<Wizard
						...
						<WizardItem id='step1' title='Basic Infos' >
							...
							{errorHandling && formik.errors.email ? (
								...
								<div />
										...
										<FormGroup label='Marial status*' className='col-md-6'>
											<select
												id='marital'
											...
											{errorHandling && formik.errors.marital ? (
												<div className='errorMassage'>{formik.errors.marital}</div>
											) : (
												<div />
											)}
										</FormGroup>
						...
						<WizardItem id='step2' title='Personal Info'>
							...
							<FormGroup label='I am a' className='col-3'>
											<select
												id='iAm'
												className='form-select'
												name='iAm'
										...
										<FormGroup label='Looking for' className='col-3'>
											<select
												id='looking'
												className='form-select'
												name='looking'
											...
											{errorHandling && formik.errors.looking ? (
												<div className='errorMassage'>{formik.errors.looking}</div>
											) : (
												<div />
											)}
										</FormGroup>
