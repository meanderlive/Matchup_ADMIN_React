...
import Add from "./Add_Admin";
 
import Edit_User from "./Edit_Admin";
import OrderDeleteModal from "./Delete_Admin";
...
const ChangeRole = async (e:any)=>{
  ...
  return (
    <PageWrapper title={demoPagesMenu.crm.subMenu.customersList.text}>
      ...
      <div className="display-5 col-md-7 fw-bold my-3 ">Admin Management</div>
