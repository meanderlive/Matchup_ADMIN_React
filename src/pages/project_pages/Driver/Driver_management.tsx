...
import Add from "./Add_Driver";
 
import Edit_User from "./Edit_Driver";
import OrderDeleteModal from "./Delete_Driver";
...
const ChangeRole = async (e:any)=>{
  ...
  return (
    <PageWrapper title={demoPagesMenu.crm.subMenu.customersList.text}>
      ...
      <div className="display-5 col-md-7 fw-bold my-3 ">Driver Management</div>
