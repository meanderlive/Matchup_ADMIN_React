...
import Add from "./Add_Provider";
 
import Edit_User from "./Edit_Provider";
import OrderDeleteModal from "./Delete_Provider";
...
const ChangeRole = async (e:any)=>{
  ...
  return (
    <PageWrapper title={demoPagesMenu.crm.subMenu.customersList.text}>
      ...
      <div className="display-5 col-md-7 fw-bold my-3 ">ProviderManagement</div>
