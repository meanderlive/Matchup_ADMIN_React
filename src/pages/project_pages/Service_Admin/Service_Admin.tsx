...
import Add from "./Add_ServiceAdmin";
 
import Edit_User from "./Edit_serviceAdmin";
import OrderDeleteModal from "./Delete_ServiceAdmin";
...
const ChangeRole = async (e:any)=>{
  ...
  return (
    <PageWrapper title={demoPagesMenu.crm.subMenu.customersList.text}>
      ...
      <div className="display-5 col-md-7 fw-bold my-3 ">Service Admin </div>
      <div className="col-md-4">
                    <FormGroup>
                      <Label htmlFor="role">Change Admin</Label>
                      <Select
                        id="role"
                        name="role"
                        ariaLabel="Role"
