...
import { create_demstaffs, getAll_demstaffs } from "../../../redux/Slice/Staff_Slice ";
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        formData.append("other", values.other.trim());
        ...
        // ✅ Submit FormData
        const response = await dispatch(create_demstaffs({ formData }) as any);
        ...
        <ModalBody className="px-4 user-modal-body">
          <form onSubmit={formik.handleSubmit} >
            <div className="row g-4 align-items-center" style={{}}>
              ...
              <FormGroup id="specialization" label="Specialization" className="col-md-12">
                <Input
                  name="specialization"
                  type="text"
                  onChange={formik.handleChange}
                ...
                {errorHandling && formik.errors.specialization ? (
                  <div className="errorMassage">{formik.errors.specialization}</div>
                ) : (
                  <div />
                )}
              </FormGroup>
              <FormGroup id="price" label="Price" className="col-md-12">
                ...
                {errorHandling && formik.errors.price ? (
                  <div className="errorMassage">{formik.errors.price}</div>
                ) : (
                  <div />
                )}
              </FormGroup>
              <FormGroup id="other" label="Other" className="col-md-12">
                <Input
                  name="other"
                  type="text"
                  onChange={formik.handleChange}
                ...
                {errorHandling && formik.errors.other ? (
                  <div className="errorMassage">{formik.errors.other}</div>
                ) : (
                  <div />
                )}
              </FormGroup>
