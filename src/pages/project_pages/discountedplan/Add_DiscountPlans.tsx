...
import { create_Disconutplan, getAll_Disconutplan } from "../../../redux/Slice/DiscountPlans_Slice";
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        // ✅ Submit FormData
        const response = await dispatch(create_Disconutplan({ formData }) as any);
            ...
            <div className="row g-4 align-items-center" style={{}}>
              <FormGroup id="title" label="Title" className="col-md-6">
                ...
                {errorHandling && formik.errors.title ? (
                  <div className="errorMassage">{formik.errors.title}</div>
                ) : (
                  <div />
                )}
              </FormGroup>
