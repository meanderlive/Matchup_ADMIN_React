...
import Add from "./Add_Plans";

import Edit_User from "./Edit_Plans";
import OrderDeleteModal from "./Delete_Plans";
  ...
  return (
    <PageWrapper title={demoPagesMenu.crm.subMenu.customersList.text}>
      <div className="row  justify-content-around">
        <div className="display-5 col-md-7 fw-bold my-3 ">Offer's</div>
        <div className="col-md-4">
          <FormGroup>
            <Label htmlFor="role">Change Offer's</Label>
            <Select
              id="plan"
              name="plan"
              ariaLabel="Plans"
