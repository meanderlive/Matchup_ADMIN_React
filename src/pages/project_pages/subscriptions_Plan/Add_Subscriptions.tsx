...
import { createSubscriptionPlan, getallSubscriptionPlan } from "../../../redux/Slice/SubscriptionPlans_Slice";
  ...
  const formik = useFormik({
    ...
    onSubmit: async (values) => {
      ...
      try {
        ...
        // ✅ Submit FormData
        const response = await dispatch(createSubscriptionPlan(formData ) as any);
    ...
    return (
      ...
      >
        <ModalHeader setIsOpen={setIsOpen} className="p-4">
          <ModalTitle id={id}>{item?.name || ""}</ModalTitle>
        </ModalHeader>
